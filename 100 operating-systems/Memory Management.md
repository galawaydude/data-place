...
The solution for the above thing is, Multi-level paging, where the page (Basically to avoid making one very big page table, we make smaller page tables), you have an outer page table that points to a second-level page tab
